...
class using_ : public using_base<Delegate, Derived>
             ...
             , public ReflectedMembers<utils::Delayed<reflection::auto_, Delegate>, non_void_t<Derived, using_<Delegate, Derived>>>
{
public:
    using ReflectedMembers<Delegate,                                    non_void_t<Derived, using_<Delegate, Derived>>>::operator=;
    using ReflectedMembers<utils::Delayed<reflection::auto_, Delegate>, non_void_t<Derived, using_<Delegate, Derived>>>::operator=;
